...
import { getDemoState, formatTimeSaved, calculateTimeSavingsValue } from "@/utils/demo";

export function ValueSummary() {
  const [demoState] = useState(getDemoState);
  const isConnected = demoState.connected;
  
  // Calculate saved time in different formats
  ...
  // Calculate data accuracy improvement percentage
